...
describe('main', function () {
    it('should pass', function () {
        const result = main(['', '', 'bin/file_input.txt']);
        expect(result).equal(`Created parking lot with 6 slots
...
4 KA-01-HH-7777
5 KA-01-HH-2701
Allocated slot number: 6Sorry, parking lot is full
...
Allocated slot number: 1Allocated slot number: 3Sorry, parking lot is full
Slot No.  Registration No.
1 KA-09-HH-0987
2 KA-01-HH-9999
3 CA-09-IO-1111
